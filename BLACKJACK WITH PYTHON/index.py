...
def hit_or_stand(deck,hand):
    ...
    while True:
        ...
        if x[0].lower()=='h':
            ...
            print('Sorry I did not understant that input, enter h or s only')
            continue
        break

# Write functions to display cards
def show_some(player,dealer):
    # show only one card from the player's hand
...
def show_all(player,dealer):
    # show all the dealer card
    print("\n Dealer's hand")
    for card in dealer.cards:
        print(card)
        
    # calculate and display the value of the cards in dealer
    ...
    # calculate and display the value of the cards in player
...
def dealer_busts(player,dealer,chips):
    print('Players Wins! Dealer Busted')
    chips.win_bet()
